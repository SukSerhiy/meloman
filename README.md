...
The project is made on [React](https://ru.reactjs.org/) using [Redux](https://redux.js.org/) as state manager with [axios](https://github.com/axios/axios) and [redux-thunk](https://github.com/reduxjs/redux-thunk) for making api requests.
